...
<div class="card col-lg-10 mx-auto py-3 mt-5" >
    <div class="card-body">
        <h5 class="card-title ps-3 py-3">Product | Detail product <strong>#${product.productId}</strong> </h5>
        <%--@elvariable id="product" type="java"--%>
        <form:form action="/products/update/${product.productId}" method ="POST" enctype="multipart/form-data" modelAttribute="product">
            <div class="row mt-3 align-items-center">
                <%--@declare id="productid"--%><label class="col-lg-2 text-end py-2" for="productId">
                    Product name:
                </label>
                <div class="col-lg-3">
                    <input name="productId" type="text" class="form-control" disabled value="${product.productId}"  id ="productId"/>
                     </div>
            </div>
            ...
            <div class="row mt-3 ">
                <div class="col-md-12 text-center">
                    <button type="submit" name="" class="btn btn-success mx-2" ><i class="fa-solid fa-right-to-bracket"></i> Update</button>
